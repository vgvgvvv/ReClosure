...
namespace ReClosure {
    ...
    public static class UDebug {
        ...
        private static LogDelegate WriteErrorDelegate = Console.Error.WriteLine;
        private static LogExceptionDelegate WriteExceptionDelegate = (Exception e) => Console.Error.WriteLine(e);
#endif
            ...
            set {
                if ( _enabled != value ) {
                    ...
                    if ( _enabled ) {
                        ...
                        _LogError = WriteErrorDelegate;
                        _LogException = WriteExceptionDelegate;
                        _LogWarning = WriteErrorDelegate;
#endif
                    } else {
                        _Log = NoAction;
                        _LogError = NoAction;
...
#if RE_CLOSURE_FOR_UNITY && UNITY_EDITOR
